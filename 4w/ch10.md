...
- 이벤트와 엔티티 대한 사실을 일반적인 데이터 구조를 사용하는 것
- 이게 뭔소리인가 싶어서 시작 된 긴 여정의 요약
- 찾다보니 해당 책의 저자가 직접 올린 팟캐스트 발견
...
- 즉, 데이터는 기본 형태의 데이터로 두고 실제 개발은 위에 인터페이스를 잘 쌓아서 사용하라는 뜻
...
\*\* 뭔소리인가 싶어서 찾아본 내용들<br>
저자가 직접 설명한 내용 : https://ericnormand.me/podcast/what-is-data-orientation<br>
무난한 내용의 설명 글 : https://yozm.wishket.com/magazine/detail/2157/<br>
